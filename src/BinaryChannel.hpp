...
public:
    BinaryReader(boost::json::object config);
    ...
    uint8_t readHex8() override;
    uint16_t readHex16() override;
    uint32_t readHex32() override;
...
public:
    BinaryWriter(boost::json::object config);
